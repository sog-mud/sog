/*
 * $Id: interp.c,v 1.141 1999-05-20 06:24:55 avn Exp $
 */
...
cmd_t cmd_table[] =
{
    ...
    { "delet",		do_delet,	POS_DEAD,	 0,  LOG_NORMAL, CMD_KEEP_HIDE | CMD_CHARMED_OK | CMD_FROZEN_OK },
    ...
    { "poison",		do_poison_smoke,POS_FIGHTING,	 0,  LOG_NORMAL	},
    ...
    { "sla",		do_sla,		POS_DEAD,	L3,  LOG_NORMAL	},
    ...
    { "gecho",		do_echo,	POS_DEAD,	L4,  LOG_NORMAL	},
    { ">",		do_echo,	POS_DEAD,	L4,  LOG_NORMAL	},
    ...
    { "log",		do_log,		POS_DEAD,	L1,  LOG_NORMAL	},
    ...
    { "echo",		do_recho,	POS_DEAD,	L6,  LOG_NORMAL	},
