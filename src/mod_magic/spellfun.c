...
void spell_dragon_plate(const char *sn, int level, CHAR_DATA *ch, void *vo)	
{
	OBJ_DATA *plate;
	AFFECT_DATA af;
...
void spell_dragon_weapon(const char *sn, int level, CHAR_DATA *ch, void *vo)	
{
	int sword_vnum = 0;
	OBJ_DATA *sword;
	char arg[MAX_INPUT_LENGTH];
